...
- 회사 자료와 산업 분야 근거를 모두 확인한 175곳을 **항공·우주, 자동차, AI** 아래 **소재, 공정, 부품**으로 교차 분류했습니다. 2026년 명단의 나머지 327곳과 2025년에만 확인된 4곳은 구분의 **기타**에 표시합니다. 상세 카드에는 **정보 부족**으로 표시합니다. 회사 링크가 없고 독립 자료로 확인되지 않은 업체에는 임의의 검색 결과를 연결하지 않았습니다.
