...
companies = [
 dict(key='airtech', name='Airtech International', cat='공정 · 소재 | 항공·우주 / 자동차', booth='AA8', product='복합재 툴링·진공백 공정재', status='공정 안정화', bullets=['BMIGP Carbon Prepreg 기반 툴링과 고온용 진공백 공정 솔루션을 전시.','대형 부품의 반복 성형에서 치수 안정성과 툴 수명 개선에 초점.','부품 소재 자체보다 양산 공정의 재현성과 보조재 통합 역량이 핵심.'], takeaway='대형 복합재 부품의 양산성 검토 시 툴링 수명·사이클·보조재 표준화를 함께 비교할 필요.', sources='현장 촬영·브로슈어 / airtech.com'),
 dict(key='stm', name='STM · Swift Textile Metalizing', cat='기능성 소재 · 부품 | 자동차 / 항공·우주', booth='—', product='금속도금 섬유 기반 EMI 차폐 시트', status='북미 공급망', bullets=['섬유 한 올씩 금속층을 형성하는 EnCap 공정으로 유연성과 전도성을 동시에 확보.','시트·테이프·직물 형태로 전장 부품과 배터리 주변 EMI/RF 차폐 적용 가능.','100% 미국 현지 생산이라는 점이 조달 안정성과 현지화 측면에서 의미가 큼.'], takeaway='경량 EMI 차폐가 필요한 배터리·전장 하우징에서 금속판 대체 가능성과 성형·접합성을 우선 확인.', sources='현장 촬영 / swift-textile.com'),
 ...
 dict(key='rebuild', name='Re:Build Manufacturing', cat='부품 · 공정 | 자동차 / 항공·우주', booth='—', product='연속 GF/PP 일체형 적재함·자동화 제조', status='대형 부품', bullets=['대형 CFRP 적재함과 구조 부품을 통해 설계·공정·생산 통합 역량을 전시.','대형 부품의 경량화와 부품 수 절감을 실제 형상으로 제시.','재료 공급보다 설계에서 양산 셀까지 연결하는 제조 서비스 모델이 핵심.'], takeaway='대형 자동차 부품의 사업화에는 소재 선정과 동시에 설계·치공구·자동화 파트너 구조가 중요.', sources='현장 촬영 / rebuildmanufacturing.com'),
]
...
profiles = {
 ...
 'agci': ('American GCI Resitop은 일본 Gun Ei Chemical Industry의 미국 법인이다. 페놀수지 기술을 기반으로 한 Kynol® 노볼로이드 섬유를 복합재·고무 보강 및 내열·난연 용도로 소개했다.', 'https://kynol.com'),
 ...
 'rebuild': ('Re:Build Manufacturing은 제품 설계부터 복합재 공정·자동화·생산까지 연결하는 미국 제조 엔지니어링 기업이다. 연속 유리섬유·PP 기반 대형 일체형 적재함을 통해 설계와 양산 공정의 통합 역량을 보여줬다.', 'https://rebuildmanufacturing.com'),
}

enriched = {'airtech': ['전시품은 BMIGP Carbon Prepreg 기반의 복합재 툴과 진공백 성형용 필름·이형재·실란트 등 공정 보조재.',
             'BMIGP는 비스말레이미드(BMI) 수지 기반 탄소섬유 툴링 프리프레그. 초기 경화 후 자립 상태의 후경화를 적용해 고온용 마스터 모델의 비용 부담을 줄이는 방식.',
             '전시 안내자료는 초기 경화 온도 250°F(약 121°C), 툴링 적용 온도 최대 218°C(425°F)를 제시. 두 온도는 각각 제조 조건과 사용 조건으로 구분.',
             '열산화 안정성과 미세균열 저항을 통해 반복 성형 시 툴 수명 및 보수 부담 개선을 지향하며, 항공·풍력·해양·자동차 복합재 공정에 적용.'],
 'stm': ['전시품은 은 또는 은-니켈을 도금한 직물·부직포·테이프·후크앤루프와 복합재 적층용 얇은 전도성 시트로 구성.',
         'EnCap™ 공정은 각 섬유 표면을 금속으로 완전히 감싸는 분자 결합층을 형성해 직물의 유연성·신축성을 유지하면서 반복 가능한 전도성을 확보.',
         '부직포는 기재와 코팅에 따라 약 2.0–5.0 oz/yd²이며, 전도성 후크앤루프는 체적저항 사양이 0.02 Ω·cm.',
         '전시된 차폐 제품은 100% 미국에서 생산하며, 항공 복합재 통합·EMI 가스켓·케이블 랩·장비 하우징·정전기 방지에 적용.'],
 'teubert': ['Continuous Compression Molding은 필름·UD 테이프 또는 직접 용융 수지를 연속 공급해 가열과 압축을 단계적으로 수행.',
             '직선 프로파일뿐 아니라 곡률, 가변 단면, 국부 보강이 포함된 복잡 형상 샘플을 통해 기존 인발성형과 다른 형상 자유도를 제시.',
             '공정 조건은 최대 25 bar·500°C 조건과 1% 미만 기공률을 목표로 하며, 장척 보강재·프레임·구조 프로파일 생산에 적용.'],
 'krempel': ['KremGuard는 에폭시계 프리프레그로 할로겐·페놀·포름알데히드 없이 높은 화염·연기·독성(FST) 성능을 확보하도록 설계.',
             'FAR 25, AITM, EN 45545 HL3 및 UL 94 V-0 등 운송 분야 난연 요구에 대응하는 제품군을 보유. 적용 규격은 제품 등급별로 구분.',
             '허니컴 패널, 전기 절연 구조재, 철도·항공 내장재와 배터리 하우징처럼 구조 성능과 화재 안전을 함께 요구하는 부품에 적용.'],
 'polynt': ['전시품은 압축성형한 자동차 외장·구조 부품과 표면 품질을 보여주는 SMC 샘플로 구성.',
            'Polynt SMC는 불포화 폴리에스터·비닐에스터 또는 에폭시 수지에 무기 충전재와 유리·탄소섬유를 조합한 성형용 시트이며, 공급 폭은 약 135–150 cm.',
            'SMCarbon®은 탄소섬유 강화 에폭시·비닐에스터 SMC 제품군으로 강성·경량·열적 안정성을 목표로 함.',
            '배터리 커버·하우징용 SMC에는 저수축·유리/탄소섬유 구성이 제시되며, 외관 부품에는 Class-A 표면용 저수축 첨가제 시스템을 적용.'],
 'agci': ['Kynol®은 페놀수지 기반 노볼로이드 섬유. 용융·적하 대신 탄화층을 형성하는 내열·난연 특성이 핵심.',
          '전시품은 Kynol 단섬유·분말·직물과 페놀계 적층판, 탄화 소재 샘플로 구성.',
          '섬유·펠트·직물은 화염 차단과 단열, 분말은 수지·고무 조성물의 난연 및 마찰재 충전용으로 사용할 수 있음.',
          '엘라스토머와의 상용성이 우수하나, 아라미드 섬유와 비교해 가격 차이가 크지 않아 원가 우위는 제한적.',
          '방화복·고온 필터·단열재·마찰재·가스켓 및 복합재 난연층에 적용.'],
 'parson': ['전시품은 GF–GF 적층판 접착 샘플과 카트리지형 접착제, 이종재 접합 조건을 정리한 시험 자료로 구성.',
            'GF–GF, GF–Metal, Metal–Metal 조합에서 400°F(약 204°C) 이상까지 접착력을 유지하는 고온 접합 특성이 강점.',
            '메타크릴레이트계 구조용 접착제는 별도 기계 체결을 줄이고 넓은 면적에 하중을 분산할 수 있으며, 대형 패널·차량·선박·산업 구조물에 적용.',
            '실제 적용 전에는 피착재별 표면처리, 접착층 두께, 경화시간과 고온·습열 노화 조건의 확인이 필요.'],
 'kelvinite': ['K2100은 할로겐·안티몬·브롬을 사용하지 않는 난연 PP. UL 94 VTM-0는 0.25 mm, V-0는 0.43 mm의 시험 두께에 해당하며, 적용 시 등급별 '
               '인증 두께 확인이 필요.',
               'K2540은 배터리 인클로저용 복합재로, 두께 2.0 mm에서 UL 2596 BETR 시험에서 18650 셀 간 열폭주 전파를 억제한 시험 결과를 보유.',
               '전시 폼 샘플은 내화 시트를 폼 형태로 만든 제품. K2400은 각형 셀 사이에 적용하는 복합재 압축 패드 시제품. 셀 간 전파 억제 및 1,200°C 화염 대응을 '
               '개발 방향으로 하며, 시제품 단계의 성능과 양산성을 검토할 대상.',
               'Composite Flame Shield는 Torch & Grit 10회 사이클 통과 성능을 보유. 화염·입자 충돌 내구 시험과 BETR 셀 간 열폭주 전파 시험은 '
               '평가 항목을 구분.',
               '기존 사용 레진을 바탕으로 BETR 통과 샘플과 맞춤 제작 가능성을 확인했으나, 전시 샘플에서는 보강 직물의 함침 부족이 뚜렷했음. 내화성은 우수하나 함침 및 생산성 '
               '문제는 여전히 남아 있음.'],
 'cotton': ['전시품은 면섬유와 PP를 조합해 압축성형한 트레이·판재·자동차 내장 형상 샘플로 구성.',
            '면섬유의 낮은 밀도와 열전도도, 촉감, 재생 가능한 원료라는 특성을 활용하며 일반적인 열가소성 성형 공정 적용 가능성을 제시.',
            '도어트림·트렁크 라이너·패키지 트레이 등 비구조 내장재가 대표 적용처이며, 흡습·냄새·치수 안정성과 장기 내구가 평가 항목.'],
 'exxon': ['ExxonMobil Product Solutions의 Proxxima™는 저점도 2액형 폴리올레핀 열경화 수지 플랫폼으로, 빠른 함침과 제어 가능한 경화를 목표로 함.',
           '전시품은 Proxxima™ 수지 적용 EV 배터리 하우징. 사진 3장은 동일 제품의 앞면·옆면·뒷면을 촬영한 것. Fraunhofer ICT 공동 프로젝트는 실물 규모 '
           '금형과 HP-RTM 장비를 이용한 성능·공정성 검증을 추진.',
           '수지 점도는 약 20 cP까지 낮출 수 있으며, HP-RTM·VARTM·Wet Compression·Pultrusion·Filament Winding에 적용 가능.',
           '유리·탄소·천연섬유와 조합 가능하며, 일부 공정 조건에서 2분 미만 경화가 가능한 수지 시스템. 수지 경화시간을 탈형·보강재 투입까지 포함한 전체 생산 사이클과 구분할 '
           '필요.',
           '배터리 구조부품 공동개발은 2026 CAMX Unsurpassed Innovation 최종 후보. 다음 주 Jason Lakes와의 기술 미팅에서 적층·성형 조건과 배터리 '
           '케이스 상세 기술을 확인 예정.'],
 'mast': ['전시품은 자성 충전 실리콘 시트, 탄소 충전 폼, 표면파 흡수체와 접착형 RF 흡수 샘플로 구성.',
          'MF11 탄소 충전 망상 폼은 두께별 1–40 GHz 대역을 대응하며 0.375–1.25 in 규격과 PSA 부착 옵션을 제공.',
          'MR11 tuned-frequency 시트는 1–40 GHz 범위에서 특정 공진 주파수에 맞춰 조성·두께를 설계하며 일반적으로 약 20 dB 감쇠를 목표로 함.',
          '안테나·레이돔·전자장비 하우징·항공 구조 내부의 반사파, 공진과 안테나 간 간섭 저감에 적용.'],
 'vulcan': ['전시품은 연속 알루미나 섬유 토우, 평직·능직 직물과 두께가 다른 고온 차단용 섬유 샘플로 구성.',
            '제품군은 약 1,200°C 연속 사용 사양으로, 폭 0.8–1.2 m, 면중량 180–1,600 g/m²에 대응하며 3D 직물은 약 0.8–10 mm 두께까지 설계 가능.',
            '요구 폭·두께·직조 조직으로 맞춤 제작할 수 있고 유럽 및 싱가포르 공급망을 통해 고온 단열·화염 차단 구조에 적용.',
            '세라믹계 연속섬유 특성상 절곡·취급성, 수지 함침 및 가공비는 실제 적층 샘플로 확인할 필요.'],
 'andritz': ['전시 샘플은 Schuler가 자사 성형 공정을 이용해 제작한 복합재 부품으로, 설비·공정의 실제 성형 결과를 보여줌. SMC·GMT·RTM용 프레스와 자동화 생산라인을 '
             '함께 소개.',
             '프레스 가압력은 10,000 kN부터 160,000 kN 이상까지 대응. 압력·평행도·온도 제어와 이송 자동화를 부품 크기 및 성형 조건에 맞춰 구성.',
             'Metris Track & Trace는 부품 ID와 원재료·공정·품질 데이터를 연결하고, Energy Monitor는 부품·금형·설비 상태별 에너지 사용량을 분석.',
             '자동차 대형 SMC/GMT 구조물, 항공 복합재와 고속 RTM 생산라인에 프레스·이송·데이터 시스템을 통합 적용.'],
 'color': ['전시품은 수지별 색상·첨가제 농축 펠릿 샘플과 난연·가공조제 제품군으로 구성.',
           '난연 농축제는 할로겐계와 비할로겐계 시스템을 제공하며 폴리올레핀·스티렌계 및 일부 엔지니어링 플라스틱의 공정 조건에 맞춰 조정 가능.',
           '마스터배치는 분말 직접 투입보다 계량·분산과 작업환경 관리에 유리하지만, 섬유강화 수지에서는 점도·물성·표면 품질 변화 확인이 필요.',
           '추후 난연제와 Processing Aid의 MB 및 Powder 타입 기술자료와 샘플을 공급받아 비교할 계획.'],
 'cropper': ['전시 제품군은 TECNOFIRE® 화재 방호 매트, EMITEC™ EMI 차폐 베일, SurfaceTec™ 표면 베일과 UNIMAT™ 정렬형 섬유 매트로 구성.',
             'TECNOFIRE®는 복합재 내부에 함께 성형하는 0.5 mm급 팽창성 매트. 약 450°C에서 최대 35배 팽창해 단열 탄화층을 형성하는 제품으로 소개.',
             'EMITEC™은 금속 코팅 섬유 기반의 경량 전도성 베일. 34 g/m² Cu-Ni 부직포 적용 사례에서 약 60 dB 차폐 성능을 보이며, 실제 성능은 주파수·적층 '
             '조건에 따라 달라짐.',
             'SurfaceTec™은 탄소·유리·아라미드·폴리에스터 및 혼합 섬유 기반 표면 베일. 보강재 무늬 전사와 핀홀을 줄이고, 내마모·내식·정전기 방지 기능과 후가공 절감을 '
             '지원.',
             'UNIMAT™은 VECTIS™ 정렬 기술로 생산하는 미함침 섬유 매트. 약 95%의 섬유 정렬도, 최대 폭 1,200 mm, 20–200 g/m²로 재생·생산 부산물 '
             '섬유의 방향성 보강을 구현.',
             '2025년 확인한 내화·차폐 제품의 기본 방향은 유지. 올해는 CFR(Carbon Fiber Recycling)과의 재생 탄소섬유 기술이 2026 CAMX '
             'Unsurpassed Innovation 최종 후보로 소개됨.'],
 'toray': ['전시품은 CFRP 오버랩 압력용기, 자전거 프레임, 압축성형 판재와 항공·모빌리티 구조 샘플로 구성.',
           'TORAYCA® regular tow·Z600, ZOLTEK™ PX35 large tow, 직물, 열경화/열가소성 프리프레그, CF-SMC 등 다양한 중간재를 공급.',
           'High-cycle RTM, 오토클레이브·OOA, 프레스·사출·필라멘트 와인딩에 대응하며 드레이핑과 CF-SMC 유동 해석도 함께 제공.',
           '고압 수소 저장용기, 항공 구조, UAM, 스포츠 부품과 자동차 구조재에 적용하며 소재·공정·평가를 통합 개발.'],
 'rebuild': ['전시품은 대형 일체형 트럭 적재함. 연속 유리섬유 강화 PP(GFPP)를 사용한 열가소성 복합재(CFRTP) 구조.',
             '부품 크기는 62 × 42 in(약 1,575 × 1,067 mm). 강재 수준 강도와 내충격·내식성을 목표로 설계했으며, 별도 보호 라이너 없이 사용하는 구조.',
             '자동 테이프 적층과 저온 열성형을 결합한 전용 공정 개발로 대형 일체형 부품을 제조. 생산 설계 기준은 2분 TAKT이며, 이는 개별 공정의 소요시간과 구분.',
             '성형 단계에서 표면 마감을 구현해 후공정을 줄이고, 부품 통합과 미국 내 복합재 공급망을 함께 제안.',
             '제품 설계, 소재·적층 설계, 치공구와 자동화까지 연결한 제조 사례로, 대형 복합재 부품의 양산성과 내구 성능을 함께 보여줌.']}
...
captions = {
 ...
 'kelvinite-1':'Torch 시험 후 탄화된 Kelvinite Flame Shield', 'kelvinite-2':'Kelvinite 보강 직물 복합재 샘플', 'kelvinite-3':'Kelvinite 내화 시트를 폼 형태로 만든 샘플',
 'cotton-1':'면섬유 강화 열가소성 압축성형 트레이', 'cotton-2':'면섬유–PP 내장용 성형 패널',
 'exxon-1':'Proxxima™ 배터리 하우징 · 앞면', 'exxon-2':'동일 배터리 하우징 · 옆면', 'exxon-3':'동일 배터리 하우징 · 뒷면',
 'mast-1':'RF 흡수 엘라스토머·탄소 충전 폼 샘플',
 'vulcan-1':'연속 알루미나 섬유 직물 샘플', 'vulcan-2':'고온용 알루미나 섬유 토우·직조 샘플',
 'andritz-1':'Schuler 자사 성형 공정으로 제작한 복합재 샘플',
 ...
 'rebuild-1':'연속 유리섬유·PP 일체형 트럭 적재함',
}
...
summary1 = page('''<div class="contents-page"><aside><div class="contents-rule"></div><h1>Contents</h1><div class="contents-rule bottom"></div></aside><main><div class="report-title">▣ CAMX2026 출장 보고서</div><ol><li>Executive Summary</li><li>전시 개요 및 산업 Trend 확인</li><li>주요 전시 업체 요약</li></ol><div class="annex">[유첨]<br>－ 부스 방문 보고서 (16개 업체)</div><div class="company-name">한화첨단소재</div><div class="report-date">2026. 9.</div></main></div>''', 'template-page cover-template')
...
rows=''.join(f'<tr><td>{i:02}</td><td><b>{html.escape(c["name"])}</b></td><td>{html.escape(section_map[c["key"]])}</td><td>{html.escape(c["product"])}</td></tr>' for i,c in enumerate(companies,1))
summary_company=page(f'''<header><span class="section-no">03</span><h1>주요 전시 업체 요약</h1></header><p class="subhead">6개 대표 Section으로 구분했으며, 각 업체의 세부 적용 산업은 유첨에서 별도로 표시했다.</p><table class="company-list"><thead><tr><th>No.</th><th>업체</th><th>대표 Section</th><th>핵심 전시</th></tr></thead><tbody>{rows}</tbody></table><footer>CAMX 2026 REPORT <span>03</span></footer>''')

contacts = json.loads((ROOT / 'contact-info.json').read_text())
followups = {
 'color': '난연제 및 Processing Aid의 P.W(Powder)·MB(Masterbatch) 타입 제품 상세 설명과 기술자료를 받고, 샘플을 수령할 계획.',
 'exxon': '다음 주 배터리 케이스 관련 기술 미팅에서 수지 특성 및 성형 공정의 상세 내용을 확인할 예정.',
}
takeaways = {
 'cropper': ['화재 안전·EMI·표면 품질·재생 탄소섬유에 대응하는 기능성 소재 포트폴리오를 갖춘 기업.', '기존 내화·차폐 기능에 정렬형 재생 섬유와 표면 후가공 절감을 더해, 성능과 제조 효율을 함께 높이는 방향.'],
 'kelvinite': ['내화 시험 성능과 복합재 제조성 사이의 차이가 핵심. 실제 전시 샘플의 미함침을 고려하면 함침·층간 접착·생산성 개선이 적용 판단의 우선 조건.'],
 'stm': ['유연한 EMI 차폐 시트를 실제로 100% 미국에서 생산. 차폐 성능뿐 아니라 현지 조달이 중요한 프로젝트에서 차별점이 명확함.'],
 'agci': ['엘라스토머와의 상용성이 차별점이나 아라미드 대비 가격 우위는 제한적. 단순 원가 절감보다 내열·난연 기능과 배합 적합성을 기준으로 판단할 소재.'],
 'vulcan': ['고온 차단 성능에 맞춤 직조 역량을 결합. 일반 GF와 구분되는 알루미나계 연속섬유로, 요구 형상의 내화층을 설계할 수 있다는 점이 핵심.'],
 'teubert': ['열가소성 장척 부품에 곡률·가변 단면을 부여하는 CCM이 차별점. 소재 공급 형태와 가열·압축 단계를 함께 설계하는 공정 기술.'],
 'rebuild': ['연속 GF/PP의 대형 일체 성형, 부품 통합, 자동화를 결합한 양산 사례. 경량 소재 선정에 더해 후공정과 별도 라이너를 줄이는 제조 설계가 핵심.'],
 'exxon': ['초저점도 수지와 제어 가능한 경화를 결합해 함침과 생산 속도를 함께 개선하는 접근. 배터리 하우징 적용에서는 수지 경화시간보다 실제 전체 사이클의 확인이 중요.'],
}
detail=[]
for idx,c in enumerate(companies,5):
    ...
    theme_id = section_order.index(section_map[c['key']]) + 1
    takeaway_items = ''.join(f'<li>{html.escape(x)}</li>' for x in takeaways.get(c['key'], []))
    takeaway = f'<div class="takeaway"><b>Take Away</b><ul>{takeaway_items}</ul></div>' if takeaway_items else ''
    meta_class = 'meta' if info['person'] else 'meta no-contact'
    followup = f'<div class="followup"><b>후속 컨택 포인트</b><p>{html.escape(followups[c["key"]])}</p></div>' if c['key'] in followups else ''
    detail.append(page(f'''<header><span class="section-no">{idx:02}</span><h1>{html.escape(c['name'])}</h1><span class="category theme-{theme_id}"><small>SECTION</small> {html.escape(section_map[c['key']])}</span></header>
    <div class="{meta_class}"><div><span>본사 · 사업장 위치</span><b>{location}</b></div>{contact_block}<div><span>핵심 전시품</span><b>{html.escape(c['product'])}</b><span class="contact-label">회사 홈페이지</span><b><a href="{html.escape(website)}" target="_blank">{html.escape(website.replace('https://','').replace('http://','').rstrip('/'))}</a></b></div></div>
...
css += '\n.detail-page .category{font-size:11px;font-weight:700;line-height:1.3;padding:2mm 3.5mm;border-radius:3mm;border:1px solid currentColor;display:flex;align-items:center;gap:2mm;white-space:nowrap}.category small{font-size:7px;letter-spacing:1px;opacity:.7}.theme-1{color:#a04c23;background:#fff0e5}.theme-2{color:#385597;background:#edf2ff}.theme-3{color:#40745a;background:#edf7ef}.theme-4{color:#4f6172;background:#eef3f7}.theme-5{color:#845795;background:#f7effb}.theme-6{color:#276f79;background:#e9f6f7}\n.detail-page .meta{min-height:24mm}.detail-page .detail-grid{height:133mm;grid-template-columns:1fr 106mm;gap:6mm}.detail-page.has-takeaway .detail-grid,.detail-page.has-followup .detail-grid{height:114mm}.detail-page.has-takeaway.has-followup .detail-grid{height:105mm}.detail-grid li{font-size:11px;line-height:1.65;margin-bottom:3mm}.company-profile{font-size:10.8px;line-height:1.65}.detail-grid h2{font-size:14px}.detail-grid h2:nth-of-type(2){margin-top:4mm}.photos{max-height:100%;width:100%}.photos figure{width:100%}.photos figcaption{text-align:center;font-size:9px;padding:1.5mm 0;line-height:1.45}.photos.count-1 img{max-height:119mm;max-width:100%}.photos.count-2 img{max-height:57mm}.photos.count-3 img{max-height:43mm}.photos.count-3 figure:first-child img{max-height:54mm}.has-takeaway .photos.count-1 img{max-height:103mm}.has-takeaway .photos.count-2 img{max-height:48mm}.has-takeaway .photos.count-3 figure:first-child img{max-height:48mm}.has-takeaway.has-followup .photos.count-3 img{max-height:37mm}.takeaway{margin-top:2mm;padding:3mm 4mm;grid-template-columns:25mm 1fr;background:#f6f2ec}.takeaway ul{margin:0;padding-left:4mm}.takeaway li{font-size:10.5px;line-height:1.5}.takeaway b{font:bold 12px Georgia}.followup{display:grid;grid-template-columns:28mm 1fr;gap:2mm;border-top:1px solid #d7cec8;margin-top:2mm;padding:2mm 4mm}.followup b{font-size:9px;color:#9f4e27}.followup p{margin:0;font-size:10px;line-height:1.4}.company-list td{font-size:9px;padding:1.8mm 2mm}.company-list th{font-size:10px}.contact-list td{font-size:12px;padding:5mm 3mm}\n'
css += '.has-followup .photos.count-1 img{max-height:103mm}.spacious .detail-grid li{font-size:12px;line-height:1.8;margin-bottom:5mm}.spacious .company-profile{font-size:11.5px;line-height:1.8}.spacious .detail-grid h2:nth-of-type(2){margin-top:6mm}'
